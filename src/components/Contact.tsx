    ...
    return (
        <section id="contact" className="py-24 scroll-mt-20 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
            </div>
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                >
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="h-1.5 bg-primary-500 rounded-full mb-6 mx-auto"
                    />
                    <h2 className="text-4xl md:text-6xl font-bold text-primary-500 mb-4 font-serif">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        {/* Info Card 1 */}
                        <div className="glass-card rounded-2xl p-6 hover-lift border-primary-100">
                            <div className="w-12 h-12 rounded-xl bg-primary-500 flex items-center justify-center mb-4">
                                <Mail className="w-6 h-6 text-white" />
                            </div>
                            <h3 className="text-lg font-bold text-[#1A1A1A] mb-2 font-serif">Email Me</h3>
                        ...
                        <div className="glass-card rounded-2xl p-6 hover-lift border-primary-100">
                            ...
                            <h3 className="text-lg font-bold text-[#1A1A1A] mb-2 font-serif">Office Hours</h3>
                            <p className="text-sm text-slate-600 font-medium">
                        ...
                        <div className="glass-card-dark rounded-2xl p-6 hover-lift">
                            ...
                            <h3 className="text-lg font-bold text-white mb-2 font-serif">Quick Response</h3>
                            ...
                            <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8 space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-4 bg-white/50 border border-primary-100 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 outline-none transition-all font-medium text-sm rounded-xl"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-slate-600 uppercase tracking-wider ml-1">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className="w-full px-5 py-4 bg-white/50 border border-primary-100 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 outline-none transition-all font-medium text-sm rounded-xl appearance-none cursor-pointer"
                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-5 py-4 bg-white/50 border border-primary-100 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 outline-none transition-all font-medium text-sm rounded-xl resize-none"
                                    ></textarea>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        type="checkbox"
                                        className="mt-1 w-5 h-5 rounded-md accent-primary-500 cursor-pointer"
                                    />
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full btn-premium bg-primary-500 px-8 py-5 rounded-xl text-white font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                                >
                                    {status === 'submitting' ? (
                                        <>
