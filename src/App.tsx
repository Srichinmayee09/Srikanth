    ...
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center mesh-gradient gap-6 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 right-10 w-72 h-72 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
        <div className="relative z-10 glass-card rounded-3xl p-12 flex flex-col items-center gap-6">
          <div className="relative">
            <div className="absolute inset-0 bg-primary-500 rounded-full blur opacity-30 animate-pulse"></div>
            <Loader2 className="relative animate-spin w-16 h-16 text-primary-500" />
          </div>
          <p className="text-primary-500 font-bold text-lg tracking-wide font-serif">Loading Portfolio...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center mesh-gradient p-4 relative overflow-hidden">
        ...
        <div className="relative z-10 glass-card rounded-3xl p-12 text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold text-primary-500 mb-3 font-serif">Unable to Load Portfolio</h1>
          ...
          <button
            ...
            className="btn-premium bg-primary-500 px-8 py-4 rounded-xl text-white font-bold"
          >
            Try Again
          </button>
        </div>
      ...
      <main className="transition-all duration-300">
          ...
          <section id="about" className="container mx-auto px-6 pt-12 -mb-8 relative z-20 scroll-mt-24">
            <div className="glass-card p-8 md:p-10 rounded-3xl max-w-6xl mx-auto shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-primary-500 font-serif">About</h2>
              </div>
              <p className="text-[#1A1A1A] leading-relaxed text-base md:text-lg font-medium">
        ...
        <footer className="relative py-16 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent-emerald rounded-full filter blur-3xl"></div>
          </div>
          ...
          <div className="relative z-10 container mx-auto px-6 text-center">
            ...
            <div className="h-px w-32 bg-primary-500/30 mx-auto mb-6"></div>
